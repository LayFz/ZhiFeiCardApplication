...
public class RequestLogFilter implements Filter {
        ...
        try {
            ...
            if (var14) {
                ...
                if (null != originalRequest && null != requestWrapper && !originalRequest.getRequestURI().contains("health")) {
                    log.info("remoteAddress={}|requestURL={}|method={}|elapsedTime={}", new Object[]{requestWrapper.getRemoteAddr(), requestWrapper.getRequestURL(), requestWrapper.getMethod(), elapsedTime});
                }
    ...
    private void logRequest(RequestWrapper requestWrapper, HttpServletRequest originalRequest) throws IOException {
        ...
        if (this.logBody(requestWrapper)) {
            log.info("url = {}, method= {}, body={}", new Object[]{url, method, requestWrapper.getOriginalBody()});
        }
    ...
    private void logHeaders(HttpServletRequest request, String url, String method) {
        ...
        while(headers.hasMoreElements()) {
            ...
            log.debug("url = {}, method= {}, [header] {}={}", new Object[]{url, method, headerName, request.getHeader(headerName)});
        }
    ...
    private void logParameters(HttpServletRequest request, String url, String method) {
        ...
        while(paramNames.hasMoreElements()) {
            ...
            log.info("url = {}, method= {}, [param] {}={}", new Object[]{url, method, paramName, request.getParameter(paramName)});
        }
